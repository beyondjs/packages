...
declare namespace ns_0 {
  ...
  export class RepositoriesSettings implements IRepositoriesSettings {
    #private;
    get options(): IRepositoriesSettingsOptions;
