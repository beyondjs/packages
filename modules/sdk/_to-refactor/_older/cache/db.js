...
module.exports = new (class {
	...
	ready = async () => {
		...
		const name = 'bundle-distributions-code.db';
		...
		await this.#run(
			'CREATE TABLE IF NOT EXISTS bundle-distributions (' +
		...
		await this.#run(
			'CREATE UNIQUE INDEX IF NOT EXISTS distribution_id_index on distributions (distribution_id, path, extname);'
		);
