...
module.exports = new (class {
	...
	ready = async () => {
		...
		await this.#run(
			'CREATE TABLE IF NOT EXISTS analyzers (' + 'processor_id TEXT NOT NULL, ' + 'data TEXT NOT NULL);',
		);

		await this.#run('CREATE UNIQUE INDEX IF NOT EXISTS processor_id_index on analyzers (processor_id);');
		this.#ready.resolve();
	};
})();
